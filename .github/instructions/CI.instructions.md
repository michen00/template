...
- **Documentation Consistency:** Keep template-scope guidance (`AGENTS.md`, `CLAUDE.md`, `.github/copilot-instructions.md`, `.github/instructions/CI.instructions.md`, `.specify/memory/constitution.md`, and `README.md`) internally consistent with workflow behavior. When shared infrastructure changes overlap with derived-project guidance, review the dotfile counterparts and update them as needed.
